...
echo_and_run cd "/home/kw-cobot/slam_kw_ws/src/navigation/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/kw-cobot/slam_kw_ws/src/navigation/base_local_planner/setup.py" \
     \
    build --build-base "/home/kw-cobot/slam_kw_ws/build/navigation/base_local_planner" \
    install \
    --root="${DESTDIR-/}" \
